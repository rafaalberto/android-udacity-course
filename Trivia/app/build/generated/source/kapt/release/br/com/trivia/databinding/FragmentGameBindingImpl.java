...
public class FragmentGameBindingImpl extends FragmentGameBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.game == variableId) {
            setGame((br.com.trivia.GameFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setGame(@Nullable br.com.trivia.GameFragment Game) {
        this.mGame = Game;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        br.com.trivia.GameFragment.Question gameCurrentQuestion = null;
        ...
        br.com.trivia.GameFragment game = mGame;
