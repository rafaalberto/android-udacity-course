package br.com.aboutme.databinding;
import br.com.aboutme.R;
import br.com.aboutme.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    private androidx.databinding.InverseBindingListener nameTextandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // myName
            br.com.aboutme.MyName myName = mMyName;
            // myName.name
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.myName == variableId) {
            setMyName((br.com.aboutme.MyName) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMyName(@Nullable br.com.aboutme.MyName MyName) {
        this.mMyName = MyName;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
